// ---------------------------------------------------------------------------
// US state default sales tax rates (combined state + average local rates).
// Source: Tax Foundation / Avalara 2024 midpoint estimates.
// Rates are decimals (e.g. 0.08875 = 8.875%). These are suggestions only;
// merchants should verify with their local taxing authority.
// ---------------------------------------------------------------------------
...
export const US_TAX_REGIONS: TaxRegion[] = [
  ...
  { code: 'KS', name: 'Kansas', rate: 0.087 },
...
export const CUSTOM_TAX_CODE = '__custom__';
