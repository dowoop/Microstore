...
export const useItemEditorStore = create<ItemEditorState>()((set) => ({
  type: 'product', name: '', description: '', price: '', cost: '',
  sku: '', barcode: '', stock: '0', lowStockThreshold: '',
  notifyLowStock: true, category: '', status: 'draft',
  photoUrl: null, payUpfrontTemplate: '', listingRulesEnabled: false,
